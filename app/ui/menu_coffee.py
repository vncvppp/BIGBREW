...
from app.ui.pop_up import show_options_popup  # Add this import
...
ASSETS_PATH = PROJECT_ROOT / "resources" / "menu_coffee"
...
def open_order():
    try:
        subprocess.Popen([sys.executable, "-m", "app.ui.order"], cwd=str(PROJECT_ROOT))
    finally:
        try:
            window.destroy()
        except Exception:
